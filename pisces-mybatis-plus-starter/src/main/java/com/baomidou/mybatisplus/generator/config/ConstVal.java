...
public interface ConstVal {
    ...
    String META_OBJECT_HANDLER = "metaHandler";
    ...
    String HTTP_CLIENT_PATH = "httpClient_path";
    String META_OBJECT_HANDLER_PATH = "metaHandler_path";
    ...
    String TEMPLATE_HTTP_CLIENT = "/templates/httpClient.http";
    String TEMPLATE_META_OBJECT_HANDLER = "/templates/handler/metaObjectHandler.java";
