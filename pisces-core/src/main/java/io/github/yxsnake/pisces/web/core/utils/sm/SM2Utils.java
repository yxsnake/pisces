...
import io.github.yxsnake.pisces.web.core.utils.sm.model.SM2KeyPair;
...
//        }
    ...
    public static void main(String[] args) {
        ...
        SM2KeyPair<String, String> sm2KeyPair = genKeyPairAsHex();
        log.debug("\n公钥 : {}\n私钥 : {}", sm2KeyPair.getPublic(), sm2KeyPair.getPrivate());

        String pubKey = "04403a00d02b938d1e26d3a32e65aebc7654a5adc961601aef06ab66f522eef6c04eaff4ad7e9861f738c5de8c5c84dfc5320d8df4b007fe501e58983909aeafc7";
        String priKey = "2500e44421f6fe2ae6e4fcc22f743af9dccdeb6db91b4358ab4ebf4682c4ced2";
        String encrypt = encryptHex(pubKey, plainText);
        String decrypt = decryptHex(priKey, encrypt);
        log.debug("\n加密 : {}\n解密 : {}", encrypt, decrypt);
