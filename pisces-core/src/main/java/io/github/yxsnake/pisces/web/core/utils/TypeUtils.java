...
public class TypeUtils {
  ...
  public static Byte castToByte(Object value) {
    ...
    if (value instanceof String) {
      ...
      if (strVal.length() == 0
        || StringPool.NULL.equalsIgnoreCase(strVal)) {
        return null;
      }
    ...
    throw new ServiceException("can not cast to byte, value : " + value);
  }
  ...
  public static Character castToChar(Object value) {
    ...
    if (value instanceof String) {
      ...
      if (strVal.length() != 1) {
        throw new ServiceException("can not cast to char, value : " + value);
      }
  ...
  public static Short castToShort(Object value) {
    ...
    throw new ServiceException("can not cast to short, value : " + value);
  }
  ...
  public static Float castToFloat(Object value) {
    ...
    if (value instanceof String) {
      ...
      if (strVal.indexOf(StringPool.COMMA) != 0) {
        strVal = strVal.replaceAll(StringPool.COMMA, "");
      }

      return Float.parseFloat(strVal);
    }

    throw new ServiceException("can not cast to float, value : " + value);
  }
  ...
  public static Double castToDouble(Object value) {
    ...
    throw new ServiceException("can not cast to double, value : " + value);
  }
    ...
    if (value instanceof String) {
      ...
      if (strVal.indexOf('-') != -1) {
        ...
        try {
          ...
          throw new ServiceException("can not cast to Date, value : " + strVal);
        }
      }
    ...
    if (longValue < 0) {
      ...
      if ("oracle.sql.TIMESTAMP".equals(clazz.getName())) {
        ...
        try {
          ...
          throw new ServiceException("can not cast oracle.sql.TIMESTAMP to Date", e);
        }
        return (Date) result;
      }
      ...
      if ("oracle.sql.DATE".equals(clazz.getName())) {
        ...
        try {
          ...
          throw new ServiceException("can not cast oracle.sql.DATE to Date", e);
        }
        return (Date) result;
      }

      throw new ServiceException("can not cast to Date, value : " + value);
    }
  ...
  public static Long castToLong(Object value) {
    ...
    if (value instanceof String) {
      ...
      if (strVal.indexOf(StringPool.COMMA) != 0) {
        strVal = strVal.replaceAll(StringPool.COMMA, StringPool.EMPTY);
      }
    ...
    throw new ServiceException("can not cast to long, value : " + value);
  }
  ...
  public static Boolean castToBoolean(Object value) {
    ...
    if (value instanceof String) {
      ...
      if (strVal.length() == 0 || StringPool.NULL.equalsIgnoreCase(strVal)) {
        return null;
      }

      if (Boolean.TRUE.toString().equalsIgnoreCase(strVal) || "1".equals(strVal)) {
        return Boolean.TRUE;
      }

      if (Boolean.FALSE.toString().equalsIgnoreCase(strVal) || "0".equals(strVal)) {
  ...
  public static <T> T castToEnum(Object obj, Class<T> clazz) {
    try {
      ...
      throw new ServiceException("can not cast to : " + clazz.getName(), ex);
    }

    throw new ServiceException("can not cast to : " + clazz.getName());
  }
